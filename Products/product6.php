...
<html>
    ...
    <body>
        ...
        <section class="product">
            <div class="images">
                <img src="../Designs/women_cherryplotion_shirt_front.jpg.jpg" id="Big">
                <img src="../Designs/women_cherryplotion_shirt_back.jpg.jpg" id="Small">
            </div>
            <div class="info">
                ...
                <select class="sortItems" name="size">
                    ...
                    <input type="hidden" name="product_code" value="6-2">
