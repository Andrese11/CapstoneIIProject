...
<html>
    ...
    <body>
        ...
        <section class="product">
            <div class="images">
                <img src="../Cherry Clothing Designs/Pants/CherrySportPant/men_cherry_sport_pant_front.jpg.jpg" id="Big">
                <img src="../Cherry Clothing Designs/Pants/CherrySportPant/men_cherry_sport_pant_back.jpg.jpg" id="Small">
            </div>
            <div class="info">
                <form action = "../PHPForms/addToCart.php" method="POST">
                <h2><strong>Cherry Sport Fit Pant for Men</strong></h2>
                ...
                <select class="sortItems" name="size">
                    ...
                    <input type="hidden" name="product_code" value="20-1">
