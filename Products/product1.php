...
<html>
    ...
    <body>
        ...
        <section class="product">
            <div class="images">
                <img src="../Designs/men_cherry_plain_shirt_front.jpg.jpg" id="Big">
                <img src="../Designs/men_cherry_plain_shirt_back.jpg.jpg" id="Small">
            </div>
            <div class="info">
                <form action = "../PHPForms/addToCart.php" method="POST">
                    ...
                    <input type="hidden" name="product_code" value="1-1">
