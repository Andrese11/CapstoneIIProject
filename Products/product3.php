...
<html>
    ...
    <body>
        ...
        <section class="product">
            <div class="images">
                <img src="../Cherry Clothing Designs/Shirts/CherryRetroShirt/men_cherry_retro_shirt_front.jpg.jpg" id="Big">
                <img src="../Cherry Clothing Designs/Shirts/CherryRetroShirt/men_cherry_retro_shirt_back.jpg.jpg" id="Small">
            </div>
            <div class="info">
                <form action = "../PHPForms/addToCart.php" method="POST">
                <h2><strong>Cherry Retro Shirt for Men</strong></h2>
                ...
                <select class="sortItems" name="size">
                    ...
                    <input type="hidden" name="product_code" value="3-1">
